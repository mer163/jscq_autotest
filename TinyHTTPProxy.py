...
#                     if display_headers: print
#                     'URL: %s request' % self.path
...
#     msg
#     print
#     sys.argv[0], "[-p port] [-l logfile] [-dh] [allowed_client_name ...]]"
#     print
#     print
#     "   -p       - Port to bind to"
#     print
...
#     server_address = ('192.168.10.144', port)
