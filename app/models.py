...
class TestCases(db.Model):
    ...
    checkpoint = db.Column(db.String(5000))
    correlation = db.Column(db.String(5000))
...
class Mock(db.Model):
    ...
    def __repr__(self):
        return '<Mock %r>' % self.title

class TestLogs(db.Model):
    __tablename__ = 'testlogs'
    id = db.Column(db.Integer,primary_key=True)
    starttime = db.Column(db.DATETIME,default=datetime.utcnow())
    endtime = db.Column(db.DATETIME,default=datetime.utcnow())
    logname = db.Column(db.String(50))
    logpath = db.Column(db.String(50))
    url = db.Column(db.String(500))
    result = db.Column(db.String(50))

    def __init__(self,  starttime,endtime,logname,logpath,url,result):
        # self.id = id
