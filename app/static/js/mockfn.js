...
function add(){
	...
	if(type=="add"){
		var reqUrl=mockUrl+"/addinfo";
	}else{
		var reqUrl=mockUrl+"/editinfo";
	}
	$.ajax({
		type:"post",
		url:reqUrl,
